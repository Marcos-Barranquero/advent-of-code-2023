...
if __name__ == '__main__':
  ...
  # Anwser
  print(results)
  print(sum([result.handfuls[0].blue for result in results]))
  print(sum([result.handfuls[0].green for result in results]))
  print(sum([result.handfuls[0].red for result in results]))
